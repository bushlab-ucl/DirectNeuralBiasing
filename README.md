...
An example Jupyter Notebook demonstrating this process can be found in: [`src/pythonlib/direct-neural-biasing-demo-0.6.x.ipynb`](https://github.com/bushlab-ucl/DirectNeuralBiasing/blob/main/src/pythonlib/direct-nerual-biasing-demo-0.6.x.ipynb)
