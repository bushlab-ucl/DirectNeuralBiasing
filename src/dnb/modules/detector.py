...
class EventDetector(Module):
    ...
    Args:
        ...
        ema_alpha: Exponential moving average decay rate for running
            baseline statistics.  Smaller values give smoother but
            slower-converging estimates.  Default 0.01.
    """
